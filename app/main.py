...
from services.emprestimo_service import (
    verificar_atrasos_e_multas,
    livro_esta_emprestado,
)

from services.cliente_service import (
    cliente_tem_emprestimos_ativos,
)

from services.prateleira_service import (
    prateleira_tem_livros,
)

from services.multa_service import (
    calcular_valor_multa,
)
...
from layout.appbar import (
    construir_appbar,
)

from layout.navigation import (
    navigation_bar_mobile,
    _indice_rotas,
)

from layout.router import (
    route_change,
)

from layout.responsive import (
    on_resize,
)
...
def main(page: ft.Page):
    ...
    prateleira_nome = ft.TextField(
        ...
        hint_text="Ex: Terror",
        prefix_icon=ft.Icons.TABLE_ROWS_OUTLINED,
        expand=True,
        border_radius=BORDER_RADIUS,
    )
    ...
    livro_autor = ft.TextField(
        label="Autor",
        hint_text="Ex: J.R.R. Tolkien",
        prefix_icon=ft.Icons.CREATE_OUTLINED,
        expand=True,
        border_radius=BORDER_RADIUS,
    )
    ...
    livro_prateleira = ft.Dropdown(
        label="Prateleira",
        leading_icon=ft.Icons.LAYERS_OUTLINED,
        expand=True,
    )
    ...
    emprestimo_livro = ft.Dropdown(
        ...
        leading_icon=ft.Icons.MENU_BOOK_OUTLINED,
        expand=True,
    )
    ...
    async def salvar_e_atualizar(msg: str = None):
        ...
        route_change(
            page=page,
            estado=estado,
            atualizar_dropdowns=atualizar_dropdowns,
            construir_appbar=construir_appbar,
    ...
    def criar_layout_form(
        ...
        return (
            ft.Column(controles, spacing=spacing)
            if estado["mobile"]
            else ft.Row(controles, spacing=spacing)
        )
    ...
    page.on_resize = lambda e: on_resize(
        e=e,
        estado=estado,
        route_change=lambda: route_change(
            page=page,
            estado=estado,
            atualizar_dropdowns=atualizar_dropdowns,
            construir_appbar=construir_appbar,
